...
public class SearchResult {
    ...
    public String getTitleofResult() {
        ...
        WebElement element = parentElement.findElement(By.xpath("//*[contains(@class,'css-sycj1h')]"));
    ...
    public Boolean openSizechart() {
        try {
            ...
            WebElement element = parentElement.findElement(By.xpath("//*[contains(@class,'css-sycj1h')]/div/div[1]//button[1]"));
            element.click();
