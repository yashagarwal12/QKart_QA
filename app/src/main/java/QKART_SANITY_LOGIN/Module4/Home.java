...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            wait.until(ExpectedConditions.or(ExpectedConditions.textToBe(By.xpath("//*[@id='root']/div/div/div[3]/div[1]/div[2]/div/h4"),"No products found"),
            ExpectedConditions.textToBePresentInElementLocated(By.xpath("//div[contains(@class,'hero')]//following-sibling::div/div/div/div/p[1]"), product)));
            Thread.sleep(3000);
            return true;
        } catch (Exception e) {
